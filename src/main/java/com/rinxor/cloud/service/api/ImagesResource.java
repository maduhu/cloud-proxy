...
public class ImagesResource {
    ...
    @Path("/isos")
    @Produces("application/x-javascript")
    public Response isos(@Context HttpHeaders headers, @Context UriInfo ui, @Context HttpServletRequest req) {
    ...
    @Path("/templates")
    @Produces("application/x-javascript")
    public Response templates(@Context HttpHeaders headers, @Context UriInfo ui, @Context HttpServletRequest req) {
